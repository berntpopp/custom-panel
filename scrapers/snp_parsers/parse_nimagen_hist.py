...
class NimaGenHISTParser(BaseSNPScraper):
    ...
    def parse(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Successfully extracted {len(snps)} SNPs from NimaGen HIST panel")
        ...
        try:
            with pdfplumber.open(pdf_path) as pdf:
                for page_num, page in enumerate(pdf.pages):
                    ...
                    if ("dbSNP" in text and "Chr#" in text) or \
                       ("Location" in text and "HG38" in text) or \
            ...
            logger.info(f"Extracted {len(unique_rsids)} unique rsIDs from NimaGen HIST PDF")
            return unique_rsids
