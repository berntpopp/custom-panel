...
class IDTHybridizationParser(BaseSNPScraper):
    ...
    def parse(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Successfully extracted {len(snps)} SNPs from IDT Hybridization panel")
    ...
    def _extract_rsids_from_list(self, list_path: Path) -> List[str]:
        ...
        try:
            ...
            if not rsids:
                logger.info("No rsIDs found in expected column, trying alternative parsing")
